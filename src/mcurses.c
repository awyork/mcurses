 ...
 *---------------------------------------------------------------------------------------------------------------------------------------------------
 */
void nodelay(uint_fast8_t flag)
{
 ...
 *---------------------------------------------------------------------------------------------------------------------------------------------------
 */
void halfdelay(uint_fast8_t tenths)
{
...
void drawBoxLine(uint_fast8_t width, const char *format, ...)
{
    va_list args;
    va_start(args, format);
    ...
    quickVLine();
    addstrf("%-*.*s", inner_width, inner_width, buffer);
    quickVLine();
