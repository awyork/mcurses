...
#define B_COLOR 0xF000	 // background mask
	...
	void addstrf(const char *, ...);			  // add a string
	...
	void quickLineChar(uint_fast8_t ch);
	void drawBoxTop(uint_fast8_t);
	void drawBoxBottom(uint_fast8_t);
	void drawBoxLine(uint_fast8_t width, const char *string, ...);
...
#define LINE_SCANLINE_3 0x70 /* p -> Horizontal line (upper-mid) */
#define LINE_SCANLINE_5 0x71 /* q -> Horizontal line (center) */
#define LINE_SCANLINE_7 0x72 /* r -> Horizontal line (lower-mid) */
...
#define DEC_HORIZONTAL 0x71	 /* q */
#define DEC_VERTICAL 0x78	 /* x */
#define DEC_LOWER_RIGHT 0x6A /* j */
#define DEC_UPPER_RIGHT 0x6B /* k */
#define DEC_UPPER_LEFT 0x6C	 /* l */
#define DEC_LOWER_LEFT 0x6D	 /* m */
#define DEC_CROSS 0x6E		 /* n */
#define DEC_TEE_LEFT 0x74	 /* t */
#define DEC_TEE_RIGHT 0x75	 /* u */
#define DEC_TEE_BOTTOM 0x76	 /* v */
#define DEC_TEE_TOP 0x77	 /* w */

/* Symbols and Shapes */
#define DEC_DIAMOND 0x60	  /* ` */
#define DEC_CHECKERBOARD 0x61 /* a */
#define DEC_DEGREE 0x66		  /* f */
#define DEC_PLUS_MINUS 0x67	  /* g */
#define DEC_BULLET 0x7E		  /* ~ */
#define DEC_LEQ 0x79		  /* y (Less than or equal) */
#define DEC_GEQ 0x7A		  /* z (Greater than or equal) */
#define DEC_PI 0x7B			  /* { */
#define DEC_NOT_EQUAL 0x7C	  /* | */
#define DEC_STERLING 0x7D	  /* } */

#define DEC_ARROW_LEFT 0x7B	 /* { */
#define DEC_ARROW_UP 0x7C	 /* | */
#define DEC_ARROW_RIGHT 0x7D /* } */
#define DEC_ARROW_DOWN 0x7E	 /* ~ */
